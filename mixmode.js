var vow = "The goals of this website are to demonstrate the ability for Soroka Design to deliver a specific perspective with extreme clarity to the most diverse audience possible utilizing unconventional physical and digital interfaces experiences";

var wordsToBold=["goals","unconventional","design","diverse","clarity","experiences"];

function makeBold(input, wordsToBold) {
    return input.replace(new RegExp('(\\b)(' + wordsToBold.join('|') + ')(\\b)','ig'), '$1<span>$2</span>$3');
}
